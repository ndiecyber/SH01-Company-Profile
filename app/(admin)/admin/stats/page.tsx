...
export default function StatsListPage() {
    ...
    useEffect(() => {
        async function load() {
            const { data } = await api.get<Stat[]>("/cms/stat");
            setItems(data);
            setLoading(false);
        }
        load();
    ...
    return (
        <div>
            <div className="flex items-center justify-between mb-6">
                ...
                <Link href="/admin/stats/new" className="inline-flex items-center gap-1.5 rounded-md bg-brand px-4 py-2 text-sm font-medium text-white hover:bg-brand/90">
                            ...
                            <tr key={item.id} className="hover:bg-slate-50">
                                ...
                                <td className="px-4 py-3">
                                    <div className="flex items-center gap-2">
                                        <Link href={`/admin/stats/${item.id}/edit`} className="rounded p-1 text-slate-400 hover:text-blue-600">
