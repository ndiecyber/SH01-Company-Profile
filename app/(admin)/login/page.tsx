...
export default function LoginPage() {
    ...
    return (
        <div className="flex min-h-screen">
            {/* Left panel */}
            <div className="relative hidden overflow-hidden lg:flex lg:w-1/2 lg:flex-col lg:items-center lg:justify-center bg-navy-deep px-12">
                <div className="absolute -top-24 -left-24 h-80 w-80 rounded-full bg-brand/10" />
                <div className="absolute -bottom-32 -right-12 h-96 w-96 rounded-full bg-brand/8" />
                <div className="absolute top-1/3 right-0 h-48 w-48 rounded-full bg-white/3" />
